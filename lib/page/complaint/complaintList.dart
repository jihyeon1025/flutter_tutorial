...
import 'package:flutter_tutorial/page/complaint/complaintAdd.dart';
...
class _ComplaintListState extends State<ComplaintList> {
  final _valueList = ['전체보기', '제목', '내용', '이름', '이메일'];
            ...
            children: [
              ...
              Container(
                child: Row(
                  children: [
                    Column(
                      children: List.generate(complaintData.length, (index) {
                        Map<String, dynamic> event = complaintData[index];
