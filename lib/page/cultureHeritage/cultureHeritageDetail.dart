...
void main() {
  runApp(cultureHeritageDetail());
}

class cultureHeritageDetail extends StatefulWidget {
  @override
  _CultureHeritageDetailState createState() => _CultureHeritageDetailState();
}

class _CultureHeritageDetailState extends State<cultureHeritageDetail> {
  @override
