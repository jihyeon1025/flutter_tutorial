...
import 'package:flutter_tutorial/page/cultureHeritage/cultureHeritageDetail.dart';
import 'package:flutter_tutorial/page/cultureheritage/cultureheritageAdd.dart';
import 'package:flutter_tutorial/custom/datepicker/datePicker.dart';

class CultureHeritageList extends StatefulWidget {
  @override
  _CultureHeritageListState createState() => _CultureHeritageListState();
}

class _CultureHeritageListState extends State<CultureHeritageList> {
  final _valueList = ['전체보기', '제목', '내용'];
  var _selectedValue = '전체보기';

  List<Map<String, dynamic>> cultureheritageData = [
    {
      'ID': '1',
            ...
            children: [
              ...
              Row(
                children: [
                  Column(
                    children:
                        List.generate(cultureheritageData.length, (index) {
                      Map<String, dynamic> cultureheritage =
                          cultureheritageData[index];
