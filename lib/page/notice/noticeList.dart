...
import 'package:flutter_tutorial/page/notice/noticeAdd.dart';
            ...
            children: [
              ...
              Container(
                child: Row(
                  children: [
                    Column(
                      children: List.generate(noticeData.length, (index) {
                        Map<String, dynamic> event = noticeData[index];
