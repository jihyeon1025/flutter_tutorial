...
import 'package:flutter_tutorial/page/gallery/galleryAdd.dart';
import 'package:flutter_tutorial/page/gallery/galleryDetail.dart';
...
class _GalleryListState extends State<GalleryList> {
  final _valueList = ['전체보기', '제목'];
  var _selectedValue = '전체보기';

  List<Map<String, dynamic>> galleryData = [
    {
      'ID': '1',
      '이미지': 'assets/galleryimage2.jpeg',
      '제목': '2022 인천개항장 문화재 야행-1야행-야로-인천e지 스탬프투어',
      '행사일': '웰컴 게이트',
                  ...
                  children: [
                    Column(
                      children: List.generate(galleryData.length, (index) {
                        Map<String, dynamic> event = galleryData[index];
